...
template<class T>
static std::string sparkline_g(const rvector<T>& x, int width, bool zero)
{
...
std::string sparkline(const rvector<char>& x,               int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<short>& x,              int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<int>& x,                int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<long>& x,               int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<long long>& x,          int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<unsigned char>& x,      int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<unsigned short>& x,     int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<unsigned int>& x,       int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<unsigned long>& x,      int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<unsigned long long>& x, int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<float>& x,              int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<double>& x,             int width, bool zero) { return sparkline_g(x, width, zero); }
std::string sparkline(const rvector<long double>& x,        int width, bool zero) { return sparkline_g(x, width, zero); }
